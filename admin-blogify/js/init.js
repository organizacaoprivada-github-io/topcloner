...
(function ($) {
    ...
    skel.init({
        reset: 'full',
        breakpoints: {
            'global': { range: '*', href: 'admin-blogify/css/style.css', containers: 1200, grid: { gutters: 50 } },
            'normal': { range: '-1280', href: 'admin-blogify/css/style-normal.css', containers: 960, grid: { gutters: 40 } },
            'narrow': { range: '-1080', href: 'admin-blogify/css/style-narrow.css', containers: '100%' },
            'narrower': { range: '-820', href: 'admin-blogify/css/style-narrower.css', grid: { gutters: 30, collapse: 1 } },
            'mobile': { range: '-736', href: 'admin-blogify/css/style-mobile.css', grid: { collapse: 2 }, viewport: { scalable: false } },
            'mobilep': { range: '-480', href: 'admin-blogify/css/style-mobilep.css', grid: { gutters: 15 } }
        },
        plugins: {
            layers: {
                navPanel: {
