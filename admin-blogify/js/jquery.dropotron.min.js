...
(function (e) {
    ...
    e.fn[o] = function () {
        ...
        return e[p](e.extend({selectorParent: e(this)}, t))
    }, e[p] = function (w) {
        var et = e.extend({selectorParent: z, baseZIndex: 1e3, menuClass: p, expandMode: H, hoverDelay: 150, hideDelay: 250, openerClass: q, openerActiveClass: "active", submenuClassPrefix: "level-", mode: "fade", speed: "fast", easing: "swing", alignment: n, offsetX: 0, offsetY: 0, globalOffsetY: 0, IEOffsetX: 0, IEOffsetY: 0, noOpenerFade: y, detach: y, cloneOnDetach: y}, w), tt = et.selectorParent, nt = tt[R](B), rt = e("body"), it = e(window), st = f, ot = z, ut = z;
        tt.on(r, function () {
            nt[s](a)
        }), nt.each(function () {
            var r = e(this), p = r[b]();
            et.hideDelay > 0 && r.add(p).on("mouseleave", function () {
                ...
                switch (et.mode) {
                    case"zoom":
                        st = y, p[u](et[t]), r.animate({width: L, height: L}, et[g], et.easing, function () {
                            st = f
                        });
                        break;
                    case"slide":
                        st = y, p[u](et[t]), r.animate({height: L}, et[g], et.easing, function () {
                            st = f
                        });
                        break;
                    case"fade":
